...
public class MyServletContainerInitializer implements ServletContainerInitializer {
    ...
    public void onStartup(Set<Class<?>> arg0, ServletContext sc) throws ServletException {
       ...
       ServletRegistration.Dynamic servlet = sc.addServlet("druidStatView", new StatViewServlet());
       servlet.setInitParameter("resetEnable","true");
       servlet.setInitParameter("loginUsername","druid");
       servlet.setInitParameter("loginPassword","druid");
       //配置servlet的映射信息
        System.out.println("--statviewservlet startup---");
